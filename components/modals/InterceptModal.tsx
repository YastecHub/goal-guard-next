      ...
      <div className="relative w-full max-w-lg bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-2xl shadow-2xl shadow-black/20 dark:shadow-black/50 overflow-hidden animate-in fade-in zoom-in-95 duration-200">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2 mb-0.5">
                <h2 className="text-slate-900 dark:text-white font-bold text-base">GoalGuard Copilot Alert</h2>
                <span className="text-[10px] font-semibold uppercase tracking-wider bg-amber-500/10 text-amber-700 dark:text-amber-400 border border-amber-500/25 px-2 py-0.5 rounded-full">
                  AI Intercept
                </span>
              </div>
              <p className="text-slate-500 dark:text-slate-400 text-xs">Pause & reflect before sending</p>
            </div>
          </div>
        ...
        <div className="p-5 space-y-4">
          ...
          <div>
            ...
            <div className="bg-amber-500/5 border border-amber-500/20 rounded-xl p-4">
              <p className="text-slate-800 dark:text-slate-200 text-sm leading-relaxed">{narrativeText}</p>
            </div>
          </div>
          ...
          <div className="bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl p-4 space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3 text-xs">
              <div className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-lg p-2.5 shadow-sm">
                ...
                <p className="text-amber-600 dark:text-amber-400 font-bold">+{liveDelayDays} days</p>
              </div>
              <div className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-lg p-2.5 shadow-sm">
                <p className="text-slate-500 mb-1">Vault Impact</p>
                <p className="text-slate-800 dark:text-white font-bold">{currPct}% → {projPct}%</p>
              </div>
            </div>
          </div>
        ...
        <div className="px-5 pb-5 space-y-2.5">
          ...
          <button
            ...
            className="w-full flex items-center justify-between bg-emerald-600 hover:bg-emerald-500 text-white font-semibold py-3.5 px-5 rounded-xl transition-all shadow-lg shadow-emerald-900/20 group cursor-pointer"
          >
          ...
          <button
            onClick={executeFull}
            className="w-full py-3 px-5 rounded-xl border border-slate-200 dark:border-slate-600 text-slate-700 dark:text-slate-300 bg-white dark:bg-transparent hover:bg-slate-50 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white font-semibold text-sm transition-all cursor-pointer"
          >
          ...
          <button
            ...
            className="w-full py-2.5 text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-slate-300 text-sm transition-colors cursor-pointer"
          >
            Cancel Transfer
          </button>
        </div>
